!(function(n) {
  ...
  function(n, e, t) {
    ...
    function d(n, e) {
      var t = l(n),
        r = i(f.und(t[0]) ? 1 : t[0], 0.1, 100),
        a = i(f.und(t[1]) ? 100 : t[1], 0.1, 100),
        o = i(f.und(t[2]) ? 10 : t[2], 0.1, 100),
        c = i(f.und(t[3]) ? 0 : t[3], 0.1, 100),
        s = Math.sqrt(a / r),
        d = o / (2 * Math.sqrt(a * r)),
    ...
    var v,
      ...
      h = (function() {
        ...
        function r(r, a, o) {
          return ((n(a, o) * r + e(a, o)) * r + t(a)) * r;
        }
        function a(r, a, o) {
          return 3 * n(a, o) * r * r + 2 * e(a, o) * r + t(a);
        }
        return function(n, e, t, o) {
          if (0 <= n && n <= 1 && 0 <= t && t <= 1) {
            var u = new Float32Array(11);
            if (n !== e || t !== o)
              for (var i = 0; i < 11; ++i) u[i] = r(0.1 * i, n, t);
            return function(a) {
              return (n === e && t === o) || 0 === a || 1 === a
                ? a
                : r(c(a), e, o);
            };
          }
          function c(e) {
            for (var o = 0, i = 1; 10 !== i && u[i] <= e; ++i) o += 0.1;
            --i;
            var c = o + 0.1 * ((e - u[i]) / (u[i + 1] - u[i])),
              s = a(c, n, t);
            return s >= 0.001
              ? (function(n, e, t, o) {
                  for (var u = 0; u < 4; ++u) {
      ...
      m =
        ...
        Object.keys(g).forEach(function(n) {
          var e = g[n];
          (v["easeIn" + n] = e),
            (v["easeOut" + n] = function(n, t) {
              return function(r) {
                return 1 - e(n, t)(1 - r);
              };
            }),
            (v["easeInOut" + n] = function(n, t) {
              return function(r) {
                return r < 0.5
                  ? e(n, t)(2 * r) / 2
                  : 1 - e(n, t)(-2 * r + 2) / 2;
    ...
    function C(n, e) {
      var t = P(n);
      for (var r in e) t[r] = f.und(n[r]) ? e[r] : n[r];
      return t;
    }
    function B(n) {
      return f.rgb(n)
    ...
    function T(n, e) {
      return f.fnc(n) ? n(e.target, e.id, e.total) : n;
    }
    function E(n, e) {
      return n.getAttribute(e);
    }
    function j(n, e, t) {
      if (O([t, "deg", "rad", "turn"], I(e))) return e;
      var r = u.CSS[e + t];
      if (!f.und(r)) return r;
    ...
    function S(n, e) {
      return f.dom(n) && !f.inp(n) && (E(n, e) || (f.svg(n) && n[e]))
        ? "attribute"
        : f.dom(n) && O(o, e)
        ? "transform"
        : f.dom(n) && "transform" !== e && D(n, e)
        ? "css"
        : null != n[e]
        ? "object"
        : void 0;
    ...
    function N(n, e, t, r) {
      var a = c(e, "scale")
          ...
          : 0 +
            (function(n) {
              return c(n, "translate") || "perspective" === n
                ? "px"
                : c(n, "rotate") || c(n, "skew")
                ? "deg"
                : void 0;
    ...
    function X(n) {
      ...
      switch (n.tagName.toLowerCase()) {
        case "circle":
          return (function(n) {
            return 2 * Math.PI * E(n, "r");
          })(n);
        case "rect":
          return (function(n) {
            return 2 * E(n, "width") + 2 * E(n, "height");
          })(n);
        case "line":
          return (function(n) {
            return $(
        ...
        case "polygon":
          return (function(n) {
            var e = n.points;
            return _(n) + $(e.getItem(e.numberOfItems - 1), e.getItem(0));
          })(n);
      }
    }
    function Y(n, e) {
      var t = e || {},
        r =
          t.el ||
          (function(n) {
            for (var e = n.parentNode; f.svg(e) && f.svg(e.parentNode); )
              e = e.parentNode;
            return e;
          })(n),
    ...
    function Q(n, e) {
      var t = /[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?/g,
        r = q(f.pth(n) ? n.totalLength : n, e) + "";
      return {
        original: r,
        numbers: r.match(t) ? r.match(t).map(Number) : [0],
        strings: f.str(n) || e ? r.split(t) : []
      };
    }
    function V(n) {
      return M(n ? x(f.arr(n) ? n.map(w) : w(n)) : [], function(n, e, t) {
    ...
    function H(n, e) {
      var t = P(e);
      if ((/^spring/.test(t.easing) && (t.duration = d(t.easing)), f.arr(n))) {
        var r = n.length;
        2 === r && !f.obj(n[0])
          ? (n = { value: n })
          : f.fnc(e.duration) || (t.duration = e.duration / r);
      }
      var a = f.arr(n) ? n : [n];
      return a
        .map(function(n, t) {
          var r = f.obj(n) && !f.pth(n) ? n : { value: n };
          return (
            f.und(r.delay) && (r.delay = t ? 0 : e.delay),
            f.und(r.endDelay) &&
    ...
    function G(n, e) {
              ...
              var e = M(
                ...
                r = function(r) {
                  ...
                  t[a] = n.map(function(n) {
                    var e = {};
                    for (var t in n)
                      f.key(t) ? t == a && (e.value = n[t]) : (e[t] = n[t]);
                    return e;
                  });
                },
                a = 0;
      ...
      e))
        f.key(a) && t.push({ name: a, tweens: H(e[a], n) });
      return t;
    }
    function R(n, e) {
      var t;
    ...
    function on(n) {
      ...
      function d() {
        var n = l.direction;
        "alternate" !== n &&
          (l.direction = "normal" !== n ? "normal" : "reverse"),
      ...
      function v() {
        (t = 0), (o = p(l.currentTime) * (1 / on.speed));
      }
      function g(n, e) {
        e && e.seek(n - e.timelineOffset);
      }
      function h(n) {
        for (var e = 0, t = l.animations, r = t.length; e < r; ) {
          var a = t[e],
            o = a.animatable,
            u = a.tweens,
            c = u.length - 1,
          ...
          for (
            var f = i(n - s.start - s.delay, 0, s.duration) / s.duration,
            ...
            (b = s.isPath ? Z(s.value, d * x) : w + d * (x - w)),
              v && ((s.isColor && y > 2) || (b = Math.round(b * v) / v)),
              g.push(b);
          }
          var O = p.length;
          if (O) {
          ...
          W[a.type](o.target, a.property, m, o.transforms),
            (a.currentValue = m),
            e++;
        }
      }
      ...
      function y(n) {
        var r = l.duration,
          ...
          v = r - l.endDelay,
          y = p(n);
        (l.progress = i((y / r) * 100, 0, 100)),
          (l.reversePlayback = y < l.currentTime),
          e &&
            (function(n) {
              if (l.reversePlayback) for (var t = c; t--; ) g(n, e[t]);
              else for (var r = 0; r < c; r++) g(n, e[r]);
            })(y),
          !l.began && l.currentTime > 0 && ((l.began = !0), m("begin")),
          !l.loopBegan &&
            l.currentTime > 0 &&
            ((l.loopBegan = !0), m("loopBegin")),
          y <= a && 0 !== l.currentTime && h(0),
          ((y >= v && l.currentTime !== r) || !r) && h(r),
          y > a && y < v
            ? (l.changeBegan ||
                ((l.changeBegan = !0),
                (l.changeCompleted = !1),
      ...
      return (
        (l.reset = function() {
          ...
          (l.passThrough = !1),
            ...
            (l.changeCompleted = !1),
            (l.reversePlayback = !1),
            (l.reversed = "reverse" === n),
            (l.remaining = l.loop),
            (e = l.children);
          for (var t = (c = e.length); t--; ) l.children[t].reset();
          ((l.reversed && !0 !== l.loop) ||
            ("alternate" === n && 1 === l.loop)) &&
            l.remaining++,
    ...
    function un(n, e) {
      for (var t = e.length; t--; )
        O(n, e[t].animatable.target) && e.splice(t, 1);
    }
    "undefined" != typeof document &&
      ...
      (on.remove = function(n) {
        for (var e = V(n), t = tn.length; t--; ) {
          ...
          for (var u = o.length; u--; ) {
            var i = o[u],
              c = i.animations;
            un(e, c), c.length || i.children.length || o.splice(u, 1);
          }
      ...
      (on.set = J),
      (on.convertPx = j),
      (on.path = function(n, e) {
        var t = f.str(n) ? b(n)[0] : n,
          r = e || 100;
        return function(n) {
          return {
            property: n,
      ...
      (on.stagger = function(n, e) {
        ...
        return function(n, e, f) {
          if (
            (i && (u = 0), c && (u = (f - 1) / 2), s && (u = f - 1), !h.length)
          ) {
            for (var y = 0; y < f; y++) {
              if (a) {
          ...
          return g + (l ? (p - d) / m : d) * (Math.round(100 * h[e]) / 100) + v;
        };
      }),
      ...
      (on.easing = y),
      (on.penner = m),
      (on.random = function(n, e) {
        return Math.floor(Math.random() * (e - n + 1)) + n;
      });
    var cn = on;
    function sn() {
      var n = document.createElement("img");
      (n.src = "https://i.postimg.cc/X7PfPPv1/dog.png"),
        (n.id = "yes"),
